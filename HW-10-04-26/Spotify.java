...
class Spotify{
	public static void main(String args[])
	{
		...
		System.out.print("CHOOSE ANY ONE OF THE SINGER: ");
		
		int singer = sc.nextInt();
		
		if(singer == 1) //1. A.R. RAHMAN
		{
			...
			if(options == 1)
			{
				...
				System.out.println("3.ENNAVALEY ADI ENNAVALEY");
				System.out.println("4.MALARGALEY MALARGALEY");
				...
				{
					System.out.println("ENNAVALEY ADI ENNAVALEY....");
				}
				else if(play == 4)
				{
					System.out.println("MALARGALEY....");
				}
				else
				{
			...
			{
				System.out.println("1.VANDEY MATARAM");
				...
				if(play == 1)
				{
					System.out.println("VANDHEY MATARAM....");
				}
				else if(play == 2)
				{
			...
			else if(options == 4)
			{
				...
				{
					System.out.println("ORU POIYATHU SOL....");
				}
				else
				{
					System.out.println("CHOOSE THE SONG WITHIN THE OPTIONS ONLY!!!!");
		...
		else if(singer == 2) // ANIRUDH
		{
			...
			if(options == 1)
			{
				System.out.println("1.NEEYUM NAANUM ANBEY");
				System.out.println("2.VELICHA POOVEY");
				System.out.println("3.POO INDRU NEEYAGA");
				...
				if(play == 1)
				{
					System.out.println("NEEYUM NAANUM ANBEY....");
				}
				else if(play == 2)
				{
					System.out.println("VELICHA POOVEY....");
				}
				else if(play == 3)
				{
					System.out.println("POO INDRU NEEYAGA....");
				}
				else if(play == 4)
				{
			...
			else if(options == 4)
			{
				...
				System.out.println("3.KANNNAANA KANNNE");
		...
		else if(singer == 3)//HARRIS JEYARAJ
		{
			System.out.println("1.MELODY");
			System.out.println("2.KUTHU");
		...
		else if(singer == 4) //ILLAIYA RAJA
		{
			...
			if(options == 1)
			{
				...
				System.out.println("2.KUZHLOODHUM KANNANUKKU");
				...
				{
					System.out.println("KUZHLOODUM KANNANUKKU....");
				}
				else if(play == 3)
				{
			...
			{
				System.out.println("1.OORUVITTU ORRUVANTHU");
		...
		else if(singer == 5) // U1
		{
			...
			else if(options == 2)
			{
				...
				{
					System.out.println("VILLAYADU MANKATHA....");
				}
				else
				{
					System.out.println("CHOOSE THE SONG WITHIN THE OPTIONS ONLY!!!!");
			...
			else if(options == 4)
			{
				...
				System.out.println("2.YEDHO ONDRU ENNNAI");
				System.out.println("3.POGATHEY");
		...
		{
			System.out.println("CHOOSE THE SINGER WITHIN THE OPTIONS ONLY!!!!");
		}
	}
}
